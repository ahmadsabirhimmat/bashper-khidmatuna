const GoogleMark = () => (
  <svg className="google-signin__icon" viewBox="0 0 18 18" aria-hidden="true">
    <path
      fill="#4285F4"
...
const GoogleSignInButton = ({ busy, disabled, label, waitingLabel, onClick }) => (
  <button type="button" className="google-signin" disabled={disabled || busy} onClick={onClick}>
    {busy ? (
      waitingLabel
    ) : (
      <>
